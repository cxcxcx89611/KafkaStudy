...
public class MyProducer {
    ...
    static {
        ...
        properties.put("bootstrap.servers", "3.23.13.240:9092");
    ...
    private static void sendMessageSync() throws  Exception {
        ProducerRecord<String, String> record = new ProducerRecord<String, String>("imooc-kafka-study", "name", "sync");
    ...
    private static class MyProducerCallback implements Callback {
        ...
        public void onCompletion(RecordMetadata recordMetadata, Exception e) {
            ...
            System.out.println("Coming in MyProducer call back");
        }
    }
